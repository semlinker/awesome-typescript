...
- [playwright-praman](https://github.com/nichefish/playwright-praman) - Playwright plugin for SAP S/4HANA, Fiori & UI5 test automation — AI test generation, 199 typed control proxies, OData V2/V4, Fiori Elements, 6 auth strategies.
